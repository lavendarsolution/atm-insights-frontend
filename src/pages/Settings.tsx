            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="items-per-page" type="number" placeholder="10" defaultValue="10" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Display additional details when hovering over items</p>
                </div>
              </CardContent>
              <CardFooter>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="email-recipients" placeholder="Enter email addresses, separated by commas" />
                <p className="text-sm text-muted-foreground">Add additional team members who should receive notifications</p>
              </div>
            </CardContent>
            <CardFooter>
        ...
        <TabsContent value="account">
          <Card>
            ...
            <CardFooter className="flex justify-between">
              <Button variant="outline" onClick={() => handleSave("Account")}>
                Cancel
              </Button>
